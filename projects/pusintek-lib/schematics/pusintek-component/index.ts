import { apply, MergeStrategy, mergeWith, move, Rule, SchematicsException, template, Tree, url } from "@angular-devkit/schematics";
...
import { PusintekComponentSchema } from "./pusintek-component"; //import (schema) pusintek-component.ts
